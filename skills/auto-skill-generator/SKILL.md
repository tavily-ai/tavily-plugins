...
description: >
  Generate Claude Code skills from web research. Given a topic like "how to use Stripe API"
...
Generate Claude Code skills by researching and crawling authoritative documentation.
